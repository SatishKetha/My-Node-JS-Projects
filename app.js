...
app.put("/todos/:todoID", async (request, response) => {
  ...
  switch (true) {
    case requestBody.status !== undefined:
      columToBeUpdated = status;
      break;

    case requestBody.priority !== undefined:
      columToBeUpdated = priority;
      break;

    case requestBody.todo !== undefined:
      columToBeUpdated = todo;
      break;
  }
  ...
  //important  block. This is where the updated value is being assigned to the required column.
  const {
